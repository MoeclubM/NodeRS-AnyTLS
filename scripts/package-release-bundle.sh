...
cp scripts/migrate-upgrade.sh "$package_dir/migrate-upgrade.sh"
...
chmod +x "$package_dir/install.sh" "$package_dir/install-openrc.sh" "$package_dir/migrate-upgrade.sh" "$package_dir/upgrade.sh" "$package_dir/${BIN_NAME}"
